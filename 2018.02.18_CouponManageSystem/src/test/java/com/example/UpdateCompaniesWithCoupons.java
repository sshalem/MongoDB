...
public class UpdateCompaniesWithCoupons {
	...
	public void createCoupons() {
		...
		Coupon cftwo = new Coupon("CoffeeCoffee lunch", sd2, ed2, 10, couponType.RESTURANTS, "lunch for two persons",
				105, null, null);
		cf.createCoupon(cftwo);
		Coupon cfthree = new Coupon("CoffeeCoffee dinner", sd3, ed3, 10, couponType.RESTURANTS, "Dinner for two", 125,
				null, null);
		...
		Coupon abf = new Coupon("Aroma breakfast for 2", sd6, ed6, 10, CouponType.RESTURANTS, "Aroma Brekfast for two ",
				129, null, null);
		cf1.createCoupon(abf);
		Coupon aromaDinner = new Coupon("Aroma Dinner", sd7, ed7, 10, CouponType.RESTURANTS, "Aroma dinner", 229, null,
				null);
		...
		Coupon ad = new Coupon("Aroma Family", sd8, ed8, 10, CouponType.RESTURANTS, "Aroma dinner for family", 399,
				null, null);
		cf1.createCoupon(ad);
		Coupon ae = new Coupon("Aroma express", sd9, ed9, 10, CouponType.RESTURANTS, "Aroma express", 159, null, null);
		cf1.createCoupon(ae);
