...
public interface CompanyDAO {
	 ...
	 * @throws InterruptedException 
	 */
	Collection<Coupon> getCoupons(long companyId) throws InterruptedException;
	 ...
	 * @throws InterruptedException 
	 */
	List<Coupon> findCompanyCouponByType(long companyId, CouponType type) throws InterruptedException;
	 ...
	 * @throws InterruptedException 
	 */
	List<Coupon> findCompanyCouponByPrice(long companyId, double minimumPrice, double maximumPrice) throws InterruptedException;
	 ...
	 * @throws InterruptedException 
	 */
	List<Coupon> findCouponBetweenDates(long companyId, Date startingDate, Date endingDate) throws InterruptedException;
	 ...
	 * @throws InterruptedException 
	 */
	Coupon findCouponByName(long companyId, String title) throws InterruptedException;
	
	
	
	Coupon findCouponById(long companyId, long coupId) throws InterruptedException;
