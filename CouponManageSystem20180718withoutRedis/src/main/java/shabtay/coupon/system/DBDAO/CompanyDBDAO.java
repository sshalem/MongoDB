...
public class CompanyDBDAO implements CompanyDAO {
	 ...
	 */
	@Override
	public Coupon findCouponById(long companyId, long coupId) throws InterruptedException {
		DBConnection dbConnection = ConnectionPool.getInstance().getConnection();
		Coupon CouponByName = companyRepo.getCouponById(companyId, coupId);
		ConnectionPool.getInstance().returnConenction(dbConnection);
		return CouponByName;
	}
	 ...
	 */
	@Override
	public Coupon findCouponByName(long companyId, String coupTitle) throws InterruptedException {
		DBConnection dbConnection = ConnectionPool.getInstance().getConnection();
		Coupon CouponByName = companyRepo.getCouponByTitle(companyId, coupTitle);
		ConnectionPool.getInstance().returnConenction(dbConnection);
		return CouponByName;
	}
	 ...
	 */
	@Override
	public synchronized Collection<Coupon> getCoupons(long companyId) throws InterruptedException {
		DBConnection dbConnection = ConnectionPool.getInstance().getConnection();		
		Collection<Coupon> allCoupons = (Collection<Coupon>) companyRepo.getAllCoupons(companyId);
		ConnectionPool.getInstance().returnConenction(dbConnection);
		return allCoupons;
	}
	 ...
	 */
	@Override 
	public synchronized List<Coupon> findCompanyCouponByPrice(long companyId, double minimumPrice, double maximumPrice)
			throws InterruptedException {
		DBConnection dbConnection = ConnectionPool.getInstance().getConnection();
		List<Coupon> couponsByPrice = companyRepo.findCompanyCouponByPrice(companyId, minimumPrice, maximumPrice);
		ConnectionPool.getInstance().returnConenction(dbConnection);
	 ...
	 */
	@Override
	public synchronized List<Coupon> findCompanyCouponByType(long companyId, CouponType type) throws InterruptedException {
		DBConnection dbConnection = ConnectionPool.getInstance().getConnection();
		List<Coupon> couponsByType = companyRepo.findCompanyCouponByType(companyId, type);
		ConnectionPool.getInstance().returnConenction(dbConnection);
	 ...
	 */
	@Override
	public synchronized List<Coupon> findCouponBetweenDates(long companyId, Date startingDate, Date endingDate)
			throws InterruptedException {
		DBConnection dbConnection = ConnectionPool.getInstance().getConnection();
		List<Coupon> couponBetwenDates = companyRepo.findCouponBetweenDates(companyId, startingDate, endingDate);
		ConnectionPool.getInstance().returnConenction(dbConnection);
