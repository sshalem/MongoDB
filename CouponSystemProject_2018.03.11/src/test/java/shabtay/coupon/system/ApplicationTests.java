...
public class ApplicationTests {
	...
	private static int NUMBER_OF_COMPANIES_CREATED = 7;
	private static int NUMBER_OF_CUSTOMERS_CREATED = 5;
	private static int NUMBER_OF_COUPONS_CREATAED = 12;
	 ...
	 */
	@Test
	public void test01_adminFacade_CreateCompany() throws WrongLoginInputException, CompanyAlreadyExistException, InterruptedException {
	 ...
	 * AdminFacade class. Test Creates Company in DB , then Removes company from DB and assert checks
	 ...
	 */
	@Test
	public void test02_adminFacade_RemoveCompany() throws WrongLoginInputException, CompanyAlreadyExistException, InterruptedException {
		AdminFacade adminFacade = (AdminFacade) couponSystem.login("admin", "1234", ClientType.ADMIN);
		Company adidas = new Company("adidas", "adadi777", "adidas@gmail.com");
		adminFacade.createCompany(adidas);
	 ...
	 */
	@Test
	public void test03_adminFacade_UpdateCompany() throws WrongLoginInputException, InterruptedException {
		initializeDB();
		AdminFacade adminFacade = (AdminFacade) couponSystem.login("admin", "1234", ClientType.ADMIN);
	 ...
	 */
	@Test
	public void test04_adminFacade_GetCompany() throws WrongLoginInputException, InterruptedException {
		initializeDB();
		AdminFacade adminFacade = (AdminFacade) couponSystem.login("admin", "1234", ClientType.ADMIN);
	...
	public void test05_adminFacade_GetAllCompanies() throws WrongLoginInputException, InterruptedException {
		...
		Assert.assertEquals(NUMBER_OF_COMPANIES_CREATED, adminFacade.getAllCompanies().size());		
	}
	 ...
	 */
	@Test
	public void test06_adminFacade_CreateCustomer() throws CustomerAlreadyExistException, WrongLoginInputException, InterruptedException {
		AdminFacade adminFacade = (AdminFacade) couponSystem.login("admin", "1234", ClientType.ADMIN);
	 ...
	 * AdminFacade class. Method removes Customer and assert checks if Customer is removed 
	 * 
	 * @throws WrongLoginInputException in case login fails
	 * @throws InterruptedException 
	 */
	@Test
	public void test07_adminFacade_RemoveCustomer() throws WrongLoginInputException, InterruptedException {
		initializeDB();
		AdminFacade adminFacade = (AdminFacade) couponSystem.login("admin", "1234", ClientType.ADMIN);
	 ...
	 */
	@Test
	public void test08_adminFacade_UpdateCustomer() throws WrongLoginInputException, InterruptedException {
		initializeDB();
		AdminFacade adminFacade = (AdminFacade) couponSystem.login("admin", "1234", ClientType.ADMIN);
	 ...
	 */
	@Test
	public void test09_adminFacade_GetCustomer() throws WrongLoginInputException, InterruptedException {
		initializeDB();
		AdminFacade adminFacade = (AdminFacade) couponSystem.login("admin", "1234", ClientType.ADMIN);
	...
	public void test10_adminFacade_GetAllCustomers() throws WrongLoginInputException, InterruptedException {
		...
		Assert.assertEquals(NUMBER_OF_CUSTOMERS_CREATED, adminFacade.getAllCustomer().size());		
	}
	...
	public void test11_adminFacade_GetAllCoupon() throws WrongLoginInputException, InterruptedException {
		...
		Assert.assertEquals(NUMBER_OF_COUPONS_CREATAED, adminFacade.getAllCoupon().size());		
	}
	...
	public void test14_companyFacade_CreateCoupon()
			throws CouponAlreadyExistInCompanyDBException, WrongLoginInputException, InterruptedException {		 
		initializeDB();
	 ...
	 */
	@Test
	public void test15_companyFacade_RemoveCoupon() throws WrongLoginInputException, InterruptedException {		 
		initializeDB();
		CompanyFacade compF = (CompanyFacade) couponSystem.login("Aroma", "456456", ClientType.COMPANY);
		Coupon coupon = compF.getCouponByName("aroma");
		compF.removeCoupon(coupon);
		String expected = null;
		Coupon actual = compF.getCouponByName("aroma");		
		Assert.assertEquals(expected, actual);		
	}
	 ...
	 */
	@Test
	public void test16_companyFacade_UpdateCoupon() throws WrongLoginInputException, InterruptedException {		
		initializeDB();
		CompanyFacade companyFacde = (CompanyFacade) couponSystem.login("Aroma", "456456", ClientType.COMPANY);
	 ...
	 */
	@Test
	public void test17_companyFacade_GetCouponById() throws WrongLoginInputException, InterruptedException {		
		initializeDB();
		CompanyFacade companyFacde = (CompanyFacade) couponSystem.login("Aroma", "456456", ClientType.COMPANY);
	 ...
	 */
	@Test
	public void test18_companyFacade_GetCouponByName() throws WrongLoginInputException, InterruptedException {		
		initializeDB();
		CompanyFacade companyFacde = (CompanyFacade) couponSystem.login("Aroma", "456456", ClientType.COMPANY);
	...
	public void test24_customerFacade_PurchaseCoupon() throws CouponAlreadyPurchsedByCustomerException,
			AmountOfCouponsZeroException, CouponExpiredException, WrongLoginInputException, InterruptedException {
		
		initializeDB();
		CustomerFacade custF = (CustomerFacade) couponSystem.login("shabtay", "121212", ClientType.CUSTOMER);
		Coupon purchaseCoup = couponDBDAO.getCouponByTitle("Aroma breakfast for 2");
	...
	public void test28_customerFacade_DuplicatedCouponPurchaseByCustomerCheck()
			throws AmountOfCouponsZeroException, CouponExpiredException, WrongLoginInputException, CouponAlreadyPurchsedByCustomerException, InterruptedException {
		 
		initializeDB();
		CustomerFacade customerFacade = (CustomerFacade) couponSystem.login("karin", "2154459", ClientType.CUSTOMER);
		Coupon purchaseCoup = couponDBDAO.getCouponByTitle("CoffeeCoffee israeli Breakfast");
	...
	public void test29_customerFacade_checkAmountIsZeroException() throws CouponAlreadyExistInCompanyDBException,
			CouponAlreadyPurchsedByCustomerException, CouponExpiredException, WrongLoginInputException, AmountOfCouponsZeroException, InterruptedException {
		...
		Coupon purchaseCoup = couponDBDAO.getCouponByTitle("Coffee test");
		custF.purchaseCoupon(purchaseCoup);
	}
	...
	public void test30_customerFacade_checkCouponExpiredDateException()
			throws CouponAlreadyPurchsedByCustomerException, AmountOfCouponsZeroException, WrongLoginInputException, CouponExpiredException, InterruptedException {
	...
	// I use this test in order to Initialized DB with Companies, Customers, Coupons
