...
/**
 * Class CouponSystem is SingleTon Allows entry for nominees and execute actions
 * according their ID
 * 
...
public class CouponSystem {
	...
	/**
	 * Constructor Initializing the Daily Coupon Expiration Task.
	 */
	public CouponSystem() {
		super();
		DailyCouponExpirationTask dailyThread = new DailyCouponExpirationTask();		
