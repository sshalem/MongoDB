...
//        String curDateToStr = format.format(d1);
		...
		Coupon cfcfBreakfastforOne = new Coupon("CoffeeCoffee Breakfast", startd1, endD1, 50, couponType.RESTURANTS,
				"Breakfast for one person", 65, null, null);
		companyFacade.createCoupon(cfcfBreakfastforOne);
		Coupon cfcfBreakfastForTwo = new Coupon("CoffeeCoffee lunch", startd2, endD2, 20, couponType.RESTURANTS, "lunch for two persons",
				105, null, null);
		companyFacade.createCoupon(cfcfBreakfastForTwo);
		Coupon cfcfDinner = new Coupon("CoffeeCoffee dinner", startd3, endD3, 20, couponType.RESTURANTS, "Dinner for two", 125, null,
				null);
		companyFacade.createCoupon(cfcfDinner);
		
		Coupon cfcfUisraeliBreakfast = new Coupon("CoffeeCoffee israeli Breakfast", startd3, endD3, 20, couponType.RESTURANTS, "Dinner for two", 125, null,
				null);
		...
		Coupon aromaBreakfastForTwo = new Coupon("Aroma breakfast for 2", startd2, endD2, 75, CouponType.RESTURANTS,
				"Aroma Brekfast for two ", 129, null, null);
		companyFacade1.createCoupon(aromaBreakfastForTwo);
		Coupon aromaDinner = new Coupon("Aroma Dinner", startd3, endD3, 75, CouponType.RESTURANTS, "Aroma dinner", 229,
				null, null);
		companyFacade1.createCoupon(aromaDinner);
		Coupon aromafamilyDinner = new Coupon("Aroma Family", startd4, endD4, 85, CouponType.RESTURANTS,
				"Aroma dinner for family", 399, null, null);
		companyFacade1.createCoupon(aromafamilyDinner);
		Coupon aromaExpress = new Coupon("Aroma express", startd5, endD5, 95, CouponType.RESTURANTS, "Aroma express", 159,
				null, null);
